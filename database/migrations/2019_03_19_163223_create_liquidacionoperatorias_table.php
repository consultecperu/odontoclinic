...
class CreateLiquidacionoperatoriasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('liquidacionoperatorias', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('liquidacionoperatorias');
    }
}
