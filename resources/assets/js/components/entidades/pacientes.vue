            ...
            <div class="card text-white bg-white mb-3">
                <div class="card-header">                        
                    <div class="col pl-0 pr-0">
                        ...
                        <button type="button" class="btn btn-primary float-right" data-toggle="modal" data-target="#exampleModalLong"><span class="btn-label"><i class="flaticon-add-user"></i></span> Nuevo Paciente</button>                        
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-primary pt-5 pb-5">
                        <h5 class="modal-title title-add" id="exampleModalLongTitle">Registro de Paciente</h5>
                    ...
                    <div class="modal-body">
                        <form role="form" method="POST" v-on:submit.prevent="createPaciente">                    
                            ...
                            <div class="card-action pt-10 mb-20">
                                <button class="btn btn-danger float-right ml-10" data-dismiss="modal"><span class="btn-label"><i class="la la-times-circle"></i> Cancelar</span></button>
...
export default {
    ...
    methods: {
        ...
        createPaciente: function(){
            ...
            //console.log("datos",this.dataPaciente)    
