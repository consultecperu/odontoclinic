                    ...
                    <div class="row">
                        <div class="col-12 pl-10 pr-10">
                            <div class="nav flex-column nav-pills nav-primary" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                ...
                                <router-link :to="{ name: 'citas-pacientes' }" class="nav-link border-odonto pt-5 pb-5" id="v-pills-citas-tab" data-toggle="pill" href="#v-pills-citas" role="tab" aria-controls="v-pills-citas" aria-selected="false" exact>Citas</router-link>
