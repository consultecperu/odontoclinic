                    ...
                    styleClass="vgt-table condensed bordered striped">
                        <template slot="table-row" slot-scope="props">
                            <span v-if="props.column.field == 'btn'" class="center">
                                ...
                                <button type="button" v-tooltip="'Imprimir Presupuesto'" class="btn btn-border btn-warning btn-xs" @click.prevent="imprimirPpto(props.row)">
...
export default {
    ...
    methods:{
        ...
        processEdit(param){
            this.$router.push({ name: 'ppto-ortodoncia' , params: { idpresupuesto: param } })
        }
    }
