<template>
    <div class="row">
        ...
        <modal name="paciente" :width="'80%'" height="auto" transition="pop-out" :scrollable="true" :clickToClose="false">
            <!-- form de registro de medicos -->
                <div class="card mb-0">
                    <div class="card-header bg-primary pt-5 pb-5">
                        <div class="card-title d-inline text-white">Registro de Paciente</div>
                        <button type="button" class="close d-inline text-white" aria-label="Close" @click.prevent="$modal.hide('paciente')">
