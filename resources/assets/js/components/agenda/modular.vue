...
export default {
    ...
    mounted(){
        ...
        let calendar = new Calendar(calendarEl, {
            ...
            plugins: [ interactionPlugin, dayGridPlugin, resourceTimeGridPlugin ],
            timeZone: 'UTC',
            locale: 'es', 
            ...
            select: function(info) {
                alert('Inicio en: ' + info.startStr);
                alert('Final en: ' + info.endStr);
                alert('Coordinates: ' + info.jsEvent.pageX + ',' + info.jsEvent.pageY);
                alert('Current view: ' + info.view.type);                
            }           
        });
