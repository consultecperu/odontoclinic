...
export default {
    ...
    computed: {
        ...mapState(['user_system','sede_system','sedes','empleados','presupuestos_operatorias_detalles','conceptos','transacciones_doctor','preliquidaciondoctor']),
    ...
    methods:{
        ...
        cargaDatos(){           // separados
            ...
            this.$store.dispatch('LOAD_PRELIQUIDACIONES_DOCTORES_LIST',{ empleado_id : this.dataFiltro.empleado_id , sede_id : this.dataFiltro.sede_id , fecha_corte : fec_cor}).then(() => {
                ...
                console.log('traigo datos',this.preliquidaciondoctor)
