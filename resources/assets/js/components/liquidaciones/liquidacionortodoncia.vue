    ...
    <div class="row">
                            ...
                            <div class="row mt-20">
                                ...
                                <div class="col-4">
									<div class="form-group form-floating-label">
										...
										<label for="selectOdontologos" class="placeholder">Odontólogos</label>
									</div>
                                </div>
                                <div class="col-4">
                                                ...
                                                <div class="col-12">
                                                    <div>
                                                        <v2-table :data="rows" ref="table1"
                                                            ...
                                                            <v2-table-column label="Mats.DR." prop="material_doctor" align="left">
                                                                <template slot-scope="scope">
        ...
        <modal name="pago_liquidacion" :width="'45%'" height="auto" transition="pop-out" :scrollable="true" :clickToClose="false">
            <!-- form de registro de pago liquidacion -->
                <div class="card mb-0">
                    <div class="card-header">
                        <div class="card-title">Cancelación de Ortodoncia</div>
                    </div>
                    <div class="card-body">
                        <div class="row">
        ...
        <modal name="detalle_pago" :width="'45%'" height="auto" transition="pop-out" :scrollable="true" :clickToClose="false">
            <!-- form de registro de cargos -->
                <div class="card mb-0">
                    <div class="card-header">
                        <div class="card-title">Datos de la Cancelación Ortodoncia</div>
                    </div>
                    <div class="card-body">
...
export default {
    ...
    computed: {
        ...mapState(['user_system','sede_system','sedes','empleados','presupuestos_ortodoncias_detalles','conceptos','transacciones_doctor','preliquidaciondoctor_ortodoncia','liquidacionessedes_ortodoncia']),
    ...
    methods:{
        ...
        getRowClassName ({row, rowIndex}) {
            let encontrado = this.seleccionados.filter(sel => sel.presupuestoortodonciadetalle_id == row.presupuestoortodonciadetalle_id)      
        ...
        cargaDatos2(){        
            ...
            let self = this
            this.tableData = []
            let filtrados = this.transacciones_doctor.filter(trad => trad.sede_id == this.dataFiltro.sede_id && trad.empleado_id == this.dataFiltro.empleado_id && moment(trad.fecha,'DD-MM-YYYY').isSameOrBefore(moment(this.dataFiltro.fecha_corte,'DD-MM-YYYY')) && trad.liquidado == 0 && trad.origen == 2 )
        ...
        createLiquidacion(){
            ...
            this.$swal({
                ...
                confirmButtonText: 'Si, Liquidar!'
                    ...
                    if (result.value) {
                        this.isLoading = true
                        var url = '/api/liquidacionortodoncia';     
                        ...
                        this.$store.dispatch('LOAD_PRESUPUESTOS_ORTODONCIAS_DETALLES_LIST').then(() => {
                            this.$store.dispatch('LOAD_TRANSACCIONES_DOCTOR_LIST').then(() => {
                                this.cargaDatos()
        ...
        cargaDatosLiquidacion(){         
            ...
            this.$store.dispatch('LOAD_LIQUIDACIONES_SEDES_ORTODONCIA_LIST',{ sede_id : this.dataFiltroPL.sede_id , fecha_desde : fec_ini , fecha_hasta : fec_fin}).then(() => {
                this.rows3 = this.liquidacionessedes_ortodoncia
        ...
        facturarLiquidacion(){
            this.$swal({
                ...
                confirmButtonText: 'Si, Pagar!'
                    ...
                    if (result.value) {
                        this.loading3 = true
                        var url = '/api/liquidacionesortodoncias/facturar/'+ this.dataPago.liquidacionortodoncia_id;
